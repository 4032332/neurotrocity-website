...
export const BOOKS: Book[] = [
  ...
  { slug: 'teachers', title: 'Teacher Sh*t', status: 'live', url: STORE_URL,
    ...
    coverAlt: 'Teacher Sh*t cover: the title on a white panel over a pattern of pencils, rulers, apples, whistles and bucket hats' },
  { slug: 'high-school', title: 'High School Sh*t', status: 'live', url: STORE_URL,
    ...
    coverAlt: 'High School Sh*t cover: the title on a white panel over a pattern of clocks, laptops, coffee cups, lanyards and clipboards' },
